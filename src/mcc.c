...
int mcc_init_t6041(int node, int *path)
{
    ...
    if (reg_derived != amcc_count)
        printf("MCC: warning: amcc-count %d != reg-derived %d (reg_len %d, idx %d)\n", amcc_count,
